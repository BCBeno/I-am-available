...
export default function OwnerAvailabilityDetailsScreen({route, navigation}) {
    ...
    if (!availability) {
        ...
        return null; // don't render this screen
    }
    ...
    const handleDelete = () => {
        ...
        if (currentUser && currentUser.availabilities) {
            currentUser.availabilities.splice(availabilityIndex, 1);
        }
                    ...
                    <View style={[styles.iconRow, {marginBottom: 20}]}>
                        ...
                        <View style={[styles.readOnlyField, {flex: 1}]}>
                            <Text style={{
                                ...
                                color: '#000',
                                textAlign: 'center'
                            }}>{availability.date.replace(/-/g, '/')}</Text>
                        </View>
                    </View>
                )}
